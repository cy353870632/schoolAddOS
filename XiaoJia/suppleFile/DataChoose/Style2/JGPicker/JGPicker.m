...
- (void)initializationTopView
{
    ...
    UITapGestureRecognizer * topView_tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(topViewClick)];
    [self.backgroundView addGestureRecognizer:topView_tap];
