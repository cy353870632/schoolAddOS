...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        NSDictionary *attribute = [NSDictionary dictionaryWithObjectsAndKeys:titleLabel.font,NSFontAttributeName, nil];
        CGSize expectedSizeTitle = [title boundingRectWithSize:maxSizeTitle options: NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading  attributes:attribute context:nil].size;
...
//        CGSize expectedSizeTitle = [title sizeWithFont:titleLabel.font constrainedToSize:maxSizeTitle lineBreakMode:titleLabel.lineBreakMode]; 
    ...
    if (message != nil) {
        ...
        NSDictionary *attribute = [NSDictionary dictionaryWithObjectsAndKeys:messageLabel.font,NSFontAttributeName, nil];
        CGSize expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage options: NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading  attributes:attribute context:nil].size;
