...
- (void)setup{
    ...
    _picContainerView = [[YHWorkGroupPhotoContainer alloc] initWithWidth:MAINSCREEN.width-40];
...
- (void)layoutUI{
    ...
    // 不然在6/6plus上就不准确了
    self.labelContent.preferredMaxLayoutWidth = MAINSCREEN.width - 30;
...
- (void)layoutUI{
    ...
    // 不然在6/6plus上就不准确了
    self.labelContent.preferredMaxLayoutWidth = MAINSCREEN.width - 20;
