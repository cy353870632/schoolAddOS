...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel *labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(YH_Edges, 0, MAINSCREEN.width-YH_Edges*2, rowHeight)];
        labelTitle.tag = 101;
...
- (void)initSubViews{
    ...
    self.tableview = [[UITableView alloc] initWithFrame:CGRectMake(0,MAINSCREEN.height + tableviewH, MAINSCREEN.width, tableviewH) style:UITableViewStylePlain];
    ...
    //2.背景view
    self.backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, MAINSCREEN.height, MAINSCREEN.width, MAINSCREEN.height)];
    self.backgroundView.backgroundColor = [RGBCOLOR(195, 196, 197) colorWithAlphaComponent:0.5];
...
- (void)showViewAnimation {
    ...
    self.backgroundView.frame = CGRectMake(0, 0, MAINSCREEN.width, MAINSCREEN.height);
...
- (void)dismissViewAnimation {
    ...
    self.backgroundView.frame = CGRectMake(0, MAINSCREEN.height, MAINSCREEN.width, MAINSCREEN.height);
