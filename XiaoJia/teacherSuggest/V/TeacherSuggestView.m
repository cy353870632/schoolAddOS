...
@interface TeacherSuggestView()<UITableViewDelegate,UITableViewDataSource>
{
    UIButton * status_button;
}
@property(strong,nonatomic)ShoppingTableViewCell * cell;
@end
@implementation TeacherSuggestView
...
-(UITableView *)peixun_tableView
{
    if (!_peixun_tableView) {
        _peixun_tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(status_button.frame), MAINSCREEN.width, MAINSCREEN.height-MAINSCREEN.height/12) style:UITableViewStyleGrouped];
