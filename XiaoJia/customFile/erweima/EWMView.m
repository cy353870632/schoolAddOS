...
//        UIImageView *wechatImageView = [[UIImageView alloc] initWithFrame:CGRectMake(40, 30, SCREEN_WIDTH - 150, SCREEN_WIDTH - 150)];
//        wechatImageView.image = [self createNonInterpolatedUIImageFormCIImage:outputImage withSize:500];//重绘二维码,使其显示清晰
        [self setImage:[self createNonInterpolatedUIImageFormCIImage:outputImage withSize:500]];
    }
    return self;
}
/**
